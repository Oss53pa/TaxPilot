            ...
            <CardContent>
              <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="h6" color="info.main">
                  {formatNumber(Math.round(productiviteMoyenne))}/personne
                </Typography>
              </Box>
              <Divider sx={{ my: 1 }} />
              <Box sx={{ mb: 2 }}>
                ...
                <Table size="small">
                  ...
                  <TableBody>
                    {repartitionCA.map((row, index) => {
                      const tvaCalculee = arrondiFCFA((row.montant * row.taux) / 100)
                    ...
                    <TableRow sx={{ backgroundColor: 'grey.100' }}>
                      ...
                      <TableCell align="right" sx={{ fontWeight: 600 }}>
                        {formatNumber(repartitionCA.reduce((sum, item) => sum + arrondiFCFA(item.montant * item.taux / 100), 0))}
                      </TableCell>
                      <TableCell align="right">

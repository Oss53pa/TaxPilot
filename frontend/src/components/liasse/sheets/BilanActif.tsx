...
const BilanActif: React.FC = () => {
  ...
  const calculateTotals = (rows: any[]): Record<string, { brut: number; amort_prov: number; net: number; net_n1: number }> => {
    const totals: Record<string, { brut: number; amort_prov: number; net: number; net_n1: number }> = {

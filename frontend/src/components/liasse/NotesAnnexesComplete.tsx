...
const NotesAnnexesComplete: React.FC<NotesAnnexesCompleteProps> = ({ modeEdition: _modeEdition = false }) => {
  ...
  const notesStructure = [
    ...
    },
    {
      ...
      contenu: {
        'Fournisseurs ordinaires': '25 800 000',
        'Fournisseurs, factures non parvenues': '2 700 000',
        'Total N': '28 500 000',
        'Total N-1': '25 000 000',
        'Variation': '+14%'
      }
    },
    {
    ...
    },
    {
      ...
      contenu: {
        'Produits financiers': {
          'Intérêts des prêts': '800 000',
          'Revenus des titres': '500 000',
          'Gains de change': '1 200 000',
          'Total': '2 500 000'
        },
        'Charges financières': {
          'Intérêts des emprunts': '3 800 000',
          'Pertes de change': '600 000',
          'Autres charges financières': '400 000',
          'Total': '4 800 000'
        },
        'Résultat financier': '-2 300 000'
      }
    },
    {
      numero: 'Note 19',
              ...
              {row.map((cell, cellIndex) => (
                <TableCell 
                  ...
                  sx={{
                    ...
                    backgroundColor: row[0].includes('TOTAL') ? '#f5f5f5' : 'white',
                  }}
                >

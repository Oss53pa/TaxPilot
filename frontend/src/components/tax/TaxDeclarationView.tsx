...
export default function TaxDeclarationView() {
  ...
  const getStatusBadge = (statut: string) => {
    const variants: Record<string, 'default' | 'secondary' | 'destructive' | 'outlined'> = {
      'BROUILLON': 'secondary',
      'VALIDEE': 'outlined',
      'DEPOSEE': 'default',
      'ACCEPTEE': 'default',
              ...
              {declarations.map((declaration) => (
                <TableRow key={declaration.id}>
                  ...
                  <TableCell className="font-medium">
                    {declaration.montant_a_payer.toLocaleString('fr-FR')}
                  </TableCell>
                  <TableCell>
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">{calculResult.base_imposable.toLocaleString('fr-FR')}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-medium text-lg">{calculResult.montant_impot.toLocaleString('fr-FR')}</p>
                    </div>
                    <div>
                      <span className="text-gray-600">Solde à payer:</span>
                      <p className="font-medium text-lg text-orange-600">
                        {calculResult.solde_a_payer.toLocaleString('fr-FR')}
                      </p>
                    </div>
                  </div>
                </div>

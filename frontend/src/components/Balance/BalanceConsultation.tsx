    ...
    <Box sx={{ p: 3 }}>
      ...
      {Math.abs(totals.debit - totals.credit) > 0.01 ? (
        <Alert severity="error" sx={{ mb: 3 }}>
          Balance déséquilibrée ! Écart de {formatMontant(Math.abs(totals.debit - totals.credit))}
        </Alert>
      ) : (
            ...
            <Stack spacing={2}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={4}>
                  ...
                  <Typography variant="h6" color="info.main">
                    {formatMontant(selectedBalance.debit)}
                  </Typography>
                </Grid>
                <Grid item xs={4}>
                  <Typography variant="subtitle2" color="text.secondary">Crédit</Typography>
                  <Typography variant="h6" color="warning.main">
                    {formatMontant(selectedBalance.credit)}
                  </Typography>
                </Grid>
                <Grid item xs={4}>
                  ...
                  <Typography variant="h6" sx={{ color: getSoldeColor(selectedBalance.solde) }}>
                    {formatMontant(selectedBalance.solde)}
                  </Typography>
                </Grid>
              </Grid>
          ...
          {editedBalance && (
            <Stack spacing={2} sx={{ pt: 1 }}>
              ...
              <Box sx={{ p: 2, bgcolor: 'action.hover', borderRadius: 1 }}>
                ...
                >
                  {formatMontant(editedBalance.solde)}
                </Typography>
              </Box>
            </Stack>
          )}

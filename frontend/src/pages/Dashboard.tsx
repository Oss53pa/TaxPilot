...
const Dashboard: React.FC = () => {
  ...
  const [ratiosReels, setRatiosReels] = React.useState<any[]>([])
  const [kpisReels, setKpisReels] = React.useState<any[]>([])
  const [situationReelle, setSituationReelle] = React.useState<Record<string, any> | null>(null)

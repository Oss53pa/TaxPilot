...
const GardeBic: React.FC<PageProps> = ({ entreprise }) => {
  ...
  return (
    <Box sx={{ fontFamily: '"Courier New", Courier, monospace' }}>
      ...
      <Box sx={{ textAlign: 'center', my: 4 }}>
        <Typography sx={{ fontSize: '14pt', fontWeight: 700, fontFamily: 'inherit' }}>
          DETERMINATION DES BENEFICES
        </Typography>
        <Typography sx={{ fontSize: '14pt', fontWeight: 700, fontFamily: 'inherit' }}>
          COMMERCIAUX
        </Typography>

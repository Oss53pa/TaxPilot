...
const Garde302: React.FC<PageProps> = ({ entreprise }) => {
  ...
  return (
    <Box sx={{ fontFamily: '"Courier New", Courier, monospace' }}>
      ...
      <Box sx={{ textAlign: 'center', my: 4 }}>
        <Typography sx={{ fontSize: '12pt', fontWeight: 700, fontFamily: 'inherit', px: 4 }}>
          ETAT RECAPITULATIF DES REMUNERATIONS VERSEES A DES CONTRIBUABLES N'AYANT PAS LA QUALITE DE SALARIES
        </Typography>
        <Typography sx={{ fontSize: '12pt', fontWeight: 700, fontFamily: 'inherit', mt: 1 }}>
          (ETAT 302)
        </Typography>
      </Box>

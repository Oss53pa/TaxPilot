/**
 * Palettes de couleurs pour TaxPilot
 */
...
export const colorPalettes: ColorPalette[] = [
  // 🎨 Palette 1 – TaxPilot Default (actuel)
  {
    id: 'taxpilot-default',
    name: 'TaxPilot Default',
    description: 'Thème par défaut de TaxPilot - Minimaliste Premium',
    colors: {
...
// Palette par défaut
export const defaultPaletteId = 'taxpilot-default'

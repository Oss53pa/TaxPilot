...
export default function TaxOptimizationView() {
  ...
  const loadOptimizationData = async () => {
    try {
      ...
      const position = await taxService.analyzeFiscalPosition(entrepriseId, exerciceId)
  ...
  const compareRegimes = async () => {
    try {
      ...
      const comparison = await taxService.compareRegimes(regimeIds, {
        ca_previsionnel: simulationParams.ca_previsionnel,
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {fiscalPosition.charge_fiscale_totale?.toLocaleString('fr-FR')} FCFA
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">
                {calculateSavings().toLocaleString('fr-FR')} FCFA
              </div>
              <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="w-32 text-right font-medium">
                        {simulationParams.ca_previsionnel.toLocaleString('fr-FR')} FCFA
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="w-32 text-right font-medium">
                        {simulationParams.charges_prevues.toLocaleString('fr-FR')} FCFA
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="w-32 text-right font-medium">
                        {simulationParams.investissements_prevus.toLocaleString('fr-FR')} FCFA
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      ...
                      <strong>
                        {(simulationParams.ca_previsionnel - simulationParams.charges_prevues).toLocaleString('fr-FR')} FCFA
                      </strong>
                    </AlertDescription>
                  </Alert>
                </div>
                ...
                <CardContent className="space-y-3">
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span>{scenario.ca_projete.toLocaleString('fr-FR')} FCFA</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Charges:</span>
                      <span>{scenario.charges_prevues.toLocaleString('fr-FR')} FCFA</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Investissements:</span>
                      <span>{scenario.investissements.toLocaleString('fr-FR')} FCFA</span>
                    </div>
                  </div>
                    ...
                    <div className="border-t pt-3 space-y-2">
                      <div className="flex justify-between font-medium">
                        ...
                        <span className="text-lg">
                          {scenario.resultats.total_impots.toLocaleString('fr-FR')} FCFA
                        </span>
                      </div>
                      {scenario.resultats.economie_potentielle > 0 && (
                        <Badge variant="secondary" className="w-full justify-center">
                          Économie: {scenario.resultats.economie_potentielle.toLocaleString('fr-FR')} FCFA
                        </Badge>
                      )}
                    </div>
                  )}
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant={getPriorityColor(suggestion.priorite)}>
                        {suggestion.priorite}
                      </Badge>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    ...
                    <span className="text-lg font-bold text-green-600">
                      -{suggestion.impact_estime.toLocaleString('fr-FR')} FCFA
                    </span>
                  </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-xl font-bold text-green-600">
                          {abattement.montant_economie.toLocaleString('fr-FR')} FCFA
                        </p>
                      </div>
                    </div>
                  </div>

    ...
    <Box sx={{ p: 3 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Paper sx={{ p: 2, textAlign: 'center' }}>
            <Typography variant="h6" color={isEquilibree ? 'success.main' : 'error.main'}>
              {isEquilibree ? '✓' : `${formatMontant(ecart)} FCFA`}
            </Typography>
            <Typography variant="caption" color="text.secondary">
      ...
      {!isEquilibree && (
        <Alert severity="error" sx={{ mb: 3 }}>
          Balance déséquilibrée ! Écart de {formatMontant(ecart)} FCFA
        </Alert>
      )}
            ...
            <Grid item xs={12} md={4}>
              <Box sx={{ textAlign: 'center', p: 2, bgcolor: 'action.hover', borderRadius: 1 }}>
                ...
                <Typography variant="h5" color="info.main" sx={{ fontFamily: 'monospace' }}>
                  {formatMontant(balance.total_debit)} FCFA
                </Typography>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} md={4}>
              <Box sx={{ textAlign: 'center', p: 2, bgcolor: 'action.hover', borderRadius: 1 }}>
                ...
                <Typography variant="h5" color="warning.main" sx={{ fontFamily: 'monospace' }}>
                  {formatMontant(balance.total_credit)} FCFA
                </Typography>
              </Box>
            </Grid>
          ...
          <CardContent>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6} md={3}>
                ...
                <Typography variant="h6">
                  {formatMontant(balance.statistiques.ecart_equilibrage)} FCFA
                </Typography>
              </Grid>
            </Grid>
          </CardContent>

...
const FichesImpots: React.FC<FichesImpotsProps> = ({ modeEdition = false }) => {
  ...
  const updateImpotSociete = (field: string, value: number) => {
    ...
    setImpotSocieteData(prev => {
      ...
      if (['resultatComptable', 'reintegrationsDefinitives', 'reintegrationsTemporaires', 'deductionsDefinitives', 'deductionsTemporaires', 'deficitAnterieur'].includes(field)) {
        ...
        newData.impotCalcule = newData.beneficeImposable * (newData.tauxIS / 100)
  ...
  const updateTVA = (field: string, value: number) => {
    ...
    setTvaData(prev => {
      const newData = { ...prev, [field]: value }
      // Recalcul automatique de la TVA
      newData.tvaCollectee18 = newData.ventesImposables18 * 0.18
      newData.tvaCollectee15 = newData.ventesImposables15 * 0.15
      newData.tvaDeductible = (newData.achatsImposables + newData.immobilisationsImposables) * 0.18
                    ...
                    <Table size="small">
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell align="right">
                            {formatNumber(tvaData.achatsImposables * 0.18)}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          ...
                          <TableCell align="right">
                            {formatNumber(tvaData.immobilisationsImposables * 0.18)}
                          </TableCell>
                        </TableRow>
                        <TableRow sx={{ backgroundColor: 'grey.100' }}>

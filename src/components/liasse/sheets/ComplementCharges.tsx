  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" sx={{ fontWeight: 700, mb: 3, color: theme.palette.primary.main }}>
        Complément - Détail des Charges par Nature
      </Typography>
        ...
        <Table>
          <TableHead>
            <TableRow sx={{ backgroundColor: theme.palette.primary.main }}>
              <TableCell sx={{ color: 'white', fontWeight: 600, minWidth: 300 }}>Nature des charges</TableCell>
          ...
          <TableBody>
            ...
            {/* Total général */}
            <TableRow sx={{ backgroundColor: theme.palette.primary.light, borderTop: '2px solid ' + theme.palette.primary.main }}>

            ...
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: theme.palette.primary.main }}>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Nature du crédit</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Base de calcul</TableCell>
                  <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Taux</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Crédit généré</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Utilisé N</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>À reporter</TableCell>
                  <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Validité</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: theme.palette.success.main }}>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Nature de l'exonération</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Base exonérée</TableCell>
                  <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Taux normal</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Économie réalisée</TableCell>
                  <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Durée restante</TableCell>
                  <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Statut</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: theme.palette.warning.main }}>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Nature de la réduction</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Base de calcul</TableCell>
                  <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Taux</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Réduction</TableCell>
                  <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Imputé IS</TableCell>
                  <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Reportable</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>

...
const COMPTE_RESULTAT_STRUCTURE = [
  ...
  { type: 'line', ref: 'TA', label: 'Ventes de marchandises', indent: 1 },
  { type: 'line', ref: 'RA', label: '(-) Achats de marchandises', indent: 1, negative: true },
  { type: 'line', ref: 'RB', label: '(-/+) Variation de stocks de marchandises', indent: 1, negative: true },
  { type: 'subtotal', ref: 'XA', label: 'MARGE COMMERCIALE (TA + RA + RB)', formula: 'TA+RA+RB' },
  
  { type: 'line', ref: 'TB', label: 'Ventes de produits fabriqués', indent: 1 },
  { type: 'line', ref: 'TC', label: 'Travaux, services vendus', indent: 1 },
  { type: 'line', ref: 'TD', label: 'Production stockée (ou déstockage)', indent: 1 },
  { type: 'line', ref: 'TE', label: 'Production immobilisée', indent: 1 },
  { type: 'line', ref: 'TF', label: 'Produits accessoires', indent: 1 },
  { type: 'subtotal', ref: 'XB', label: 'CHIFFRE D\'AFFAIRES (TA + TB + TC + TD + TF)', formula: 'TA+TB+TC+TD+TF' },
  
  { type: 'line', ref: 'TG', label: 'Subventions d\'exploitation', indent: 1 },
  { type: 'line', ref: 'TH', label: 'Autres produits', indent: 1 },
  { type: 'line', ref: 'RC', label: '(-) Achats de matières premières et fournitures liées', indent: 1, negative: true },
  { type: 'line', ref: 'RD', label: '(-/+) Variation de stocks de matières premières', indent: 1, negative: true },
  { type: 'line', ref: 'RE', label: '(-) Autres achats', indent: 1, negative: true },
  { type: 'line', ref: 'RF', label: '(-/+) Variation de stocks d\'autres approvisionnements', indent: 1, negative: true },
  { type: 'line', ref: 'RG', label: '(-) Transports', indent: 1, negative: true },
  { type: 'line', ref: 'RH', label: '(-) Services extérieurs', indent: 1, negative: true },
  { type: 'line', ref: 'RI', label: '(-) Impôts et taxes', indent: 1, negative: true },
  { type: 'line', ref: 'RJ', label: '(-) Autres charges', indent: 1, negative: true },
  
  { type: 'subtotal', ref: 'XC', label: 'VALEUR AJOUTÉE', formula: 'XB+RC+RD+RE+RF+RG+RH+RI+RJ+TG+TH' },
  
  { type: 'line', ref: 'RK', label: '(-) Charges de personnel', indent: 1, negative: true },
  
  { type: 'subtotal', ref: 'XD', label: 'EXCÉDENT BRUT D\'EXPLOITATION', formula: 'XC+RK' },
  
  { type: 'line', ref: 'TI', label: 'Reprises d\'amortissements, provisions et dépréciations', indent: 1 },
  { type: 'line', ref: 'RL', label: '(-) Dotations aux amortissements', indent: 1, negative: true },
  { type: 'line', ref: 'RM', label: '(-) Dotations aux provisions et dépréciations', indent: 1, negative: true },
  
  { type: 'total', ref: 'XE', label: 'RÉSULTAT D\'EXPLOITATION', formula: 'XD+TI+RL+RM' },
  
  { type: 'section', label: 'ACTIVITÉ FINANCIÈRE', bold: true },
  
  { type: 'line', ref: 'TJ', label: 'Revenus financiers et assimilés', indent: 1 },
  { type: 'line', ref: 'TK', label: 'Gains de change', indent: 1 },
  { type: 'line', ref: 'TL', label: 'Reprises de provisions et dépréciations financières', indent: 1 },
  { type: 'line', ref: 'TM', label: 'Transferts de charges financières', indent: 1 },
  
  { type: 'line', ref: 'RN', label: '(-) Frais financiers et charges assimilées', indent: 1, negative: true },
  { type: 'line', ref: 'RO', label: '(-) Pertes de change', indent: 1, negative: true },
  { type: 'line', ref: 'RP', label: '(-) Dotations aux provisions et dépréciations financières', indent: 1, negative: true },
  ...
  { type: 'line', ref: 'TN', label: 'Produits des cessions d\'immobilisations', indent: 1 },
  { type: 'line', ref: 'TO', label: 'Autres produits HAO', indent: 1 },
  
  { type: 'line', ref: 'RQ', label: '(-) Valeurs comptables des cessions d\'immobilisations', indent: 1, negative: true },
  { type: 'line', ref: 'RR', label: '(-) Autres charges HAO', indent: 1, negative: true },
  
  { type: 'total', ref: 'XH', label: 'RÉSULTAT HAO', formula: 'TN+TO+RQ+RR' },
  
  { type: 'line', ref: 'RS', label: '(-) Impôt sur le résultat', indent: 0, negative: true },
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Stack direction="row" spacing={2}>
          <Chip
            ...
            label={`Résultat Net: ${formatNumber(resultatNet)} XOF`}
            color={isProfit ? "success" : "error"}
            variant="outlined"
          />
          
          <Chip
            label={`CA: ${formatNumber(mergedData.XB?.montant)} XOF`}
            color="primary"
            variant="outlined"
          />
          
          <Chip
            label={`EBE: ${formatNumber(mergedData.XD?.montant)} XOF`}
            color="info"
            variant="outlined"
          />

  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" sx={{ fontWeight: 700, mb: 3, color: theme.palette.primary.main }}>
        Supplément - Déclaration TVA Détaillée
      </Typography>
              ...
              <Table>
                <TableHead>
                  <TableRow sx={{ backgroundColor: theme.palette.success.main }}>
                    <TableCell sx={{ color: 'white', fontWeight: 600 }}>Opérations</TableCell>
                    <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Base HT</TableCell>
                    <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Taux</TableCell>
                    <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>TVA Collectée</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
              ...
              <Table>
                <TableHead>
                  <TableRow sx={{ backgroundColor: theme.palette.primary.main }}>
                    ...
                    <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Base HT</TableCell>
                    <TableCell align="center" sx={{ color: 'white', fontWeight: 600 }}>Taux</TableCell>
                    <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>TVA Déductible</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
              ...
              <Table size="small">
                <TableHead>
                  <TableRow sx={{ backgroundColor: theme.palette.warning.main }}>
                    <TableCell sx={{ color: 'white', fontWeight: 600 }}>Mois</TableCell>
                    <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>TVA Collectée</TableCell>
                    <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>TVA Déductible</TableCell>
                    <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>À Verser</TableCell>
                    <TableCell align="right" sx={{ color: 'white', fontWeight: 600 }}>Versé</TableCell>

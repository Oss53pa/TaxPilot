              ...
              <Card>
                <CardContent>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                    ...
                    <Typography variant="body2" fontWeight={600}>{formatNumber(totalSalaires)} F</Typography>
                  </Box>
                  <Divider sx={{ my: 1 }} />
      ...
      >
        <AccordionSummary expandIcon={<ExpandMore />}>
          <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
            ...
            <Chip label={`${formatNumber(totalEngagements)} FCFA`} color="warning" size="small" />
          </Box>
        </AccordionSummary>
        <AccordionDetails>
          <TableContainer component={Paper} variant="outlined">
      ...
      >
        <AccordionSummary expandIcon={<ExpandMore />}>
          <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
            ...
            <Chip label={`${formatNumber(totalCA)} FCFA`} color="success" size="small" />
          </Box>
        </AccordionSummary>
        <AccordionDetails>
          <Grid container spacing={3}>

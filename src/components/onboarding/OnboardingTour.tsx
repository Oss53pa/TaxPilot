/**
 * Tour guidé interactif pour nouveaux utilisateurs FiscaSync
...
const OnboardingTour: React.FC = () => {
  ...
  const tourSteps: TourStep[] = [
    {
      id: 0,
      title: 'Bienvenue dans FiscaSync !',
      ...
      <DialogContent sx={{ p: 4 }}>
        ...
        {isLastStep && (
          <Alert severity="success" sx={{ mt: 3 }}>
            <strong>Félicitations !</strong> Vous êtes maintenant prêt à utiliser FiscaSync. 

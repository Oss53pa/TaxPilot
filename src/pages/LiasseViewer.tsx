...
const LiasseViewer: React.FC = () => {
  ...
  const renderTableauBilan = () => (
    <TableContainer component={Paper} sx={{ border: '1px solid #e0e0e0' }}>
      <Table size="small" sx={{ '& .MuiTableCell-root': { border: '1px solid #e0e0e0', fontSize: '0.875rem' } }}>
        <TableHead>
        ...
        <TableBody>
          {bilanActif.map((ligne, index) => (
            <TableRow 
              key={index}
              sx={{
                backgroundColor: ligne.isHeader ? '#e3f2fd' : 
                                ligne.isSubHeader ? '#f3e5f5' : 'white',
          ...
          <Card elevation={2}>
            <CardContent sx={{ p: 0 }}>
              ...
              <Box sx={{ p: 2 }}>
                ...
                {/* Totaux */}
                <Box sx={{ mt: 2, p: 2, backgroundColor: '#e8f5e8', border: '2px solid #4caf50' }}>
                  <Grid container>
                    <Grid item xs={8}>
                      <Typography variant="h6" sx={{ fontWeight: 700 }}>
                        TOTAL ACTIF (AZ)
          ...
          <Card elevation={2}>
            <CardContent sx={{ p: 0 }}>
              ...
              <Box sx={{ p: 2 }}>
                ...
                {/* Résultat */}
                <Box sx={{ mt: 3, p: 2, backgroundColor: '#fff3e0', border: '2px solid #ff9800' }}>
                  <Typography variant="h6" sx={{ fontWeight: 700, color: 'warning.dark' }}>
                    RÉSULTAT NET DE L'EXERCICE (RZ): 8,750,000 FCFA
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
